...
5. Public `https://oompa.app/.well-known/oompa.json` readback must be strict schema version 2, generation 1, product `Oompa`, repository ID `1343008607`, path `hraness/oompa`, version `0.1.0`, and the commit belonging to that exact alias tuple.
