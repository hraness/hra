...
The v0.7.1 candidate is not yet admitted. For the admitted v0.7.0 artifact, use its [immutable README](https://github.com/hraness/hra/tree/v0.7.0#install-and-update).

Only after immutable GitHub and npm release admission, install and verify the v0.7.1 candidate CLI artifact. This does not start the daemon:
