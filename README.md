...
> **Local v0.7.0 candidate; v0.6.2 artifacts admitted; hosted sync live as an open beta.** Use the exact install command below only after immutable GitHub and npm release admission for `v0.7.0`. The [v0.6.2 artifacts](https://github.com/hraness/hra/releases/tag/v0.6.2) passed immutable GitHub and npm release admission. The website and optional hosted sync are live; candidate readiness and prior artifact admission do not authorize current-daemon startup or hosted command writers.
