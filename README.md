...
The v0.7.1 CLI artifacts passed immutable GitHub and npm release admission in [release run 34367591503](https://github.com/hraness/hra/actions/runs/34367591503), attempt 2. Artifact admission does not authorize daemon startup.

Install and verify the admitted v0.7.1 CLI artifact. This does not start the daemon:
