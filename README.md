...
Status: public beta. The local CLI v0.2.0 is live for macOS and Linux; hosted sync is live as an invite-only beta.
...
macOS and Linux CLI · macOS desktop switching · local v0.2.0 live · hosted sync live (invite-only beta)
...
> **Local release boundary.** These commands are part of the immutable `v0.2.0` local CLI release and are installable through the exact command above. Hosted sync is not required for this local protocol.
