...
> **Local release boundary.** These commands are part of the immutable `v0.4.1` local CLI release candidate and become installable through the exact command above once its GitHub Release exists. Hosted sync is not required for this local protocol.
