...
Status: public beta. The local CLI v0.2.0 is live for macOS and Linux; hosted sync is not yet live.
...
macOS and Linux CLI · macOS desktop switching · local v0.2.0 live · hosted sync not yet live
