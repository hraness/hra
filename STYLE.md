...
## Write usable product copy

- Lead installation pages with the real install command.
- Use sentence case for headings and interface labels.
- Use second person for instructions and present tense for current behavior.
- Put each limit beside the feature it limits.
- Replace praise with observable behavior or evidence.
