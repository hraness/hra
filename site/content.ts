...
export const publicContent: PublicContent = {
  ...
  questions: [
    ...
    },
    {
      ...
      answer: [text(`The website, web app, and hosted sync are available in ${hostedBetaLabel}. You can install the v${admittedReleaseVersion} CLI now. Starting or upgrading a daemon and enabling hosted commands are paused until the capacity checks pass. `), link("Check the setup status", "/docs/status/"), text(" before starting a daemon.")],
    },
    {
