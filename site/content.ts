...
const betaInstallCommand = buildHraGlobalInstallCommand(
  "https://github.com/hraness/hra/releases/download/v0.4.0/hraness-hra-0.4.0.tgz",
);
...
export const renderLlmsText = (content: PublicContent = publicContent): string =>
  [
    ...
    content.statusLine,
    "",
    `Install after the v0.4.0 beta tag is live: ${content.installCommand}`,
