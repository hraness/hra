...
export const renderLlmsText = (content: PublicContent = publicContent): string =>
  [
    ...
    `> ${content.description}`,
    "",
    `Install after the v0.1.4 beta tag is live: ${content.installCommand}`,
