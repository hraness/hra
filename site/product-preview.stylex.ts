...
const styles = stylex.create({
  figure: {
    ...
    backgroundColor: "var(--background)", overflow: "hidden", textAlign: "left", scrollMarginTop: "5rem",
  },
  ...
  button: {
    ...
    backgroundColor: { default: "transparent", ':is([aria-pressed="true"])': "var(--background)", ":hover": "var(--background)" },
    color: { default: "var(--foreground)", ":disabled": "var(--muted)" },
    borderRadius: "0.4rem", padding: "0.6rem 0.75rem", fontFamily: "var(--font-sans)", fontSize: "0.875rem",
    cursor: { default: "pointer", ":disabled": "default" }, minHeight: "2.75rem", outlineOffset: "3px",
  ...
  status: { margin: "0.4rem 0 0", fontSize: "0.875rem", lineHeight: 1.5 },
  dialog: {
