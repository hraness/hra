...
- Keep `oompa.dev` focused on the Oompa product. Do not publish adjacent tool summaries, comparison-shaped pages, or generic search-targeted essays unless a named reader job and a non-obvious Oompa-specific answer justify a durable indexable route.
