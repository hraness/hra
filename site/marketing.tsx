  ...
  return renderToStaticMarkup(
    <MarketingPage className={sitePresentationClasses("marketingPage")}>
      ...
      <MarketingInstallPanel
        ...
        heading="Install only after candidate admission."
      ...
      <MarketingCallToAction
        ...
        id="closing"
        summary="After artifact admission, install and verify the candidate CLI. After the rollout prerequisite is satisfied, initialize it, add one account, and start a session that outlives the tab it began in."
        tone="paper"
      />
