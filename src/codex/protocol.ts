...
export interface ConversationAutomationToolCall {
  ...
  /** Private provider authority. The host resolves this to one local HRA session. */
...
export function parseBrokeredCodexServerRequest(input: {
  ...
  if (mode === "url") {
    throw new CodexError(
      "UNSUPPORTED_CAPABILITY",
      "MCP URL elicitation requires a protected browser handoff that HRA 0.2.1 does not expose.",
    );
  }
