...
const expectedPackageVersion = "0.7.1";
const expectedArchiveUrl = "https://github.com/hraness/hra/releases/download/v0.7.1/hraness-hra-0.7.1.tgz";
...
const parseArchiveIdentity = (value: Record<string, unknown>): InstallArchiveIdentity => {
  ...
  if (value.archiveSource === "official") {
    if (
      ...
      || value.archiveReleaseTag !== "v0.7.1"
