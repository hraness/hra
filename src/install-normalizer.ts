...
const expectedPackageVersion = "0.6.2";
const expectedArchiveUrl = "https://github.com/hraness/hra/releases/download/v0.6.2/hraness-hra-0.6.2.tgz";
...
const parseArchiveIdentity = (value: Record<string, unknown>): InstallArchiveIdentity => {
  ...
  if (value.archiveSource === "official") {
    if (
      ...
      || value.archiveReleaseTag !== "v0.6.2"
