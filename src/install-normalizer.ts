...
const expectedPackageVersion = "0.7.0";
const expectedArchiveUrl = "https://github.com/hraness/hra/releases/download/v0.7.0/hraness-hra-0.7.0.tgz";
...
const parseArchiveIdentity = (value: Record<string, unknown>): InstallArchiveIdentity => {
  ...
  if (value.archiveSource === "official") {
    if (
      ...
      || value.archiveReleaseTag !== "v0.7.0"
