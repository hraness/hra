...
const expectedPackageVersion = "0.5.0";
const expectedArchiveUrl = "https://github.com/hraness/hra/releases/download/v0.5.0/hraness-hra-0.5.0.tgz";
...
const parseArchiveIdentity = (value: Record<string, unknown>): InstallArchiveIdentity => {
  ...
  if (value.archiveSource === "official") {
    if (
      ...
      || value.archiveReleaseTag !== "v0.5.0"
