...
export const HRA_INSTALL_CLI_SHA256 = "cd9821e16819922b5379047e86a598ff30f6a5a493dbc0b7eedb78eed740ef89";

const expectedPackageName = "@hraness/hra";
const expectedPackageVersion = "0.3.0";
const expectedArchiveUrl = "https://github.com/hraness/hra/releases/download/v0.3.0/hraness-hra-0.3.0.tgz";
...
const parseArchiveIdentity = (value: Record<string, unknown>): InstallArchiveIdentity => {
  ...
  if (value.archiveSource === "official") {
    if (
      ...
      || value.archiveReleaseTag !== "v0.3.0"
