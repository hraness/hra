...
- Keep each semantic memory store in one validated session directory outside control-plane SQLite. Purge the validated directory as a unit, including SQLite sidecars and caches; never put semantic payloads in HRA lifecycle tables.
