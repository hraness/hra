...
// An install written by the peer/local-memory predecessor is at v45 but predates
// hosted-memory authority. Storage migration tests cover older released-schema
// bridges in depth; this CLI fixture proves daemon start owns the pending v46
