 ...
 * still fit below Oompa's existing 350k-character cloud-envelope ceiling.
 */
export const OOMPA_CANONICAL_MEMORY_OPERATION_MAX_BYTES = 240 * 1024;
...
export const OOMPA_CANONICAL_MEMORY_SYNC_BUNDLE_MAX_BYTES =
...
export const canonicalMemoryCiphertextLimits = Object.freeze({
  ...
  operation: Math.floor(
    (4 * (OOMPA_CANONICAL_MEMORY_SYNC_BUNDLE_MAX_BYTES + 16) + 2) / 3,
  ),
...
export const canonicalMemoryPlaintextLimits = Object.freeze({
  ...
  descriptor: 1_024,
  operationBundle: OOMPA_CANONICAL_MEMORY_SYNC_BUNDLE_MAX_BYTES,
