// Browser-safe canonical credential grammar shared by redaction and public-code refusal.
// Scalar normalization and terminal-control handling remain in the complete redactor.
...
export const redactCanonicalSensitiveText = (
  value: string,
  replacement: string,
): string => {
