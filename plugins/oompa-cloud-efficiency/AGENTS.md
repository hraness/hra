...
- `skills/oompa-cloud-efficiency/` contains the operating skill, deterministic route gate, private CLI launch guard, managed policy assets, and discovery metadata.

# Guidelines

- Keep the folder, manifest, marketplace entry, and skill identity aligned as `oompa-cloud-efficiency`.
