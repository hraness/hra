...
export function commandTargets(bunBin: string): readonly [string, string][] {
  ...
  return [
    [join(bunBin, "oompa-cloud-adoption"), join(scripts, "repo-adoption.ts")],
    [join(bunBin, "oompa-cloud-efficiency"), join(scripts, "doctor.ts")],
    [join(bunBin, "oompa-cloud-exec"), join(scripts, "cloud-run.ts")],
