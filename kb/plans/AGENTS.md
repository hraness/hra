...
- `canonical-profile-persistence.md` scopes the next legacy-only session and Work identity migration, preserving historical provenance and separate model admission.
