...
- **Status:** Astra binding implemented and focused validation passed as Phase 4a on `claude/app-redesign-astra` (2026-09-10); integration remains pending. Phase 4b, active start-time routing, authored selection evidence, and the local disable setting, remains unimplemented. This slice does not complete Phase 4 acceptance.
