...
- 2026-08-23: The complete local release gate passed ESLint, TypeScript, 614 tests with 12,278 assertions across 65 files, generated-site parity, the production CLI and site build, public-text scanning, and isolated local and global installation of `hra-0.1.0.tgz`.
