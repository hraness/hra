...
- 2026-09-10: The browser usage view (Phase 9 as planned here) shipped as the grid meter and settings breakdown under `kb/plans/oompa-app-simplification.md` Phase 6, reading the existing hosted projection plus an additive optional reset-credit count.
