...
| 2b | 5-7 | D1, D3, C5, C6, G5, E1, E5, E7, F4, F5, F6 | Claude session runs on Linux; macOS refuses until D2 passes; `hra schema` generates the reference; README under 800 words; routing admission enforced; browser sends commands and decisions. |
