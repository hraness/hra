...
- [[plans/oompa-web-v1|Oompa Web v1: session grid, steering, autorespond, open beta]] — Status: proposed. Plan for the first real Oompa web app (a mobile-friendly grid of live sessions with steering, approvals, model choice, archive), the session-state classifier and autoresponder that…
