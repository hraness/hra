...
This note preserves the original Hot Codex seed as historical product provenance. The product is now Oompa, and its expanded implementation and migration contract is [Oompa v1](../plans/oompa-v1.md).
