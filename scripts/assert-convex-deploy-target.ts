...
export const OOMPA_EXPECTED_CONVEX_DEPLOY_URL =
  "OOMPA_EXPECTED_CONVEX_DEPLOY_URL" as const;
export const OOMPA_RESOLVED_CONVEX_DEPLOY_URL =
  "OOMPA_RESOLVED_CONVEX_DEPLOY_URL" as const;
...
export function resolvedConvexDeployTargetMatches(
  ...
  const expected = exactGeneratedDeploymentUrl(
    environment[OOMPA_EXPECTED_CONVEX_DEPLOY_URL],
  );
  const resolved = exactGeneratedDeploymentUrl(
    environment[OOMPA_RESOLVED_CONVEX_DEPLOY_URL],
  );
