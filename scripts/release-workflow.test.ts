...
describe("release workflow", () => {
  ...
  test("keeps the retired fallback-bound path unreachable and exposes only the exact artifact workflow", async () => {
    ...
    expect(releaseRecord).toContain("Status: immutable public `v0.1.6` release admitted through the durable retry contract.");
    ...
    expect(releaseRecord).toContain("The website and the `v0.1.6` local CLI are live");
    expect(releaseRecord).toContain("without changing the published `v0.1.6` bytes");
