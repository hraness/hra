...
describe("release workflow", () => {
  ...
  test("binds the candidate installer without reusing predecessor admission or claiming runtime rollout", async () => {
    ...
    expect(readme).toContain("Local v0.7.1 candidate; v0.7.0 artifacts admitted");
    expect(readme).toContain("Local CLI v0.7.1 is a release candidate; v0.7.0 remains the fully admitted public artifact.");
    expect(readme).not.toContain("Local CLI v0.7.1 is the admitted artifact");
