...
const repositorySubject = [
  "repo:hraness",
  "307125679/hra",
  "1343008607:ref:refs/tags/v0.2.0",
].join("@");
const policy = releaseSignerIdentity("v0.2.0", sha, invocation);
...
assert.equal(
  ...
  "^https://github\\.com/hraness/hra/\\.github/workflows/release\\.yml@refs/tags/v0\\.2\\.0$",
);
...
assert.throws(() => releaseSignerIdentity("v0.2.0", "b".repeat(39), invocation));
