...
describe("npm trusted-publisher boundary", () => {
  test("requires the exact GitHub-hosted HRA release identity", () => {
    expect(() => assertNpmPublisherIdentity(exactIdentity, "v0.1.6", "a".repeat(40)))
      .not.toThrow();
    ...
    expect(() => assertNpmPublisherIdentity(exactIdentity, "v0.1.7", "a".repeat(40))).toThrow();
    expect(() => assertNpmPublisherIdentity(exactIdentity, "v0.1.6", "b".repeat(40))).toThrow();
  });
