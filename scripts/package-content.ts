...
export const packageDescription = "Bun CLI and local daemon for isolated Codex and Claude Code profiles, durable sessions, and optional encrypted sync. Local CLI v0.8.0 is a release candidate; daemon and hosted command-writer rollout remains blocked on capacity.";
...
export const packageInstallPrerequisite = "Only after immutable GitHub release admission, install and verify the v0.8.0 candidate CLI artifact. This does not start the daemon:";
