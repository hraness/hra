...
| Version | Status |
| --- | --- |
| `v0.6.1` | Release candidate. Supported once the release workflow admits it. |
| `v0.6.0` | Immutable partial publication. The workflow did not complete final admission; unsupported. |
| `v0.5.0` | Last fully admitted beta. Supported until `v0.6.1` is admitted. Receives security fixes. |
