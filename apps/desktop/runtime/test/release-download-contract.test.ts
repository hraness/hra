...
const candidateContractFixture = parseReleaseDownloadContract({
  release: {
    ...
    artifacts: {
      checksum: {
        bytes: null,
        name: "HRA-0.1.13-14-macos-arm64.dmg.sha256",
        sha256: null,
      },
      dmg: {
        bytes: null,
        name: "HRA-0.1.13-14-macos-arm64.dmg",
        sha256: null,
      },
      manifest: {
        bytes: null,
        name: "HRA-0.1.13-14-release-manifest.json",
        sha256: null,
      },
    },
...
describe("release and download convergence", () => {
  test("verifies the v0.1.13 build 14 repository contract in either protocol state", async () => {
...
function expectReleaseIdentity(contract: ReleaseDownloadContract): void {
  expect(contract).toMatchObject({
    release: {
      architecture: "Apple Silicon",
      artifacts: {
        checksum: { name: "HRA-0.1.13-14-macos-arm64.dmg.sha256" },
        dmg: { name: "HRA-0.1.13-14-macos-arm64.dmg" },
        manifest: { name: "HRA-0.1.13-14-release-manifest.json" },
      },
      build: 14,
      minimumMacOS: "13",
      tag: "v0.1.13",
