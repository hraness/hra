...
- `bun-preserved-signature.macos.test.ts` – package-boundary proof that the pinned Bun signature is strict-valid only at its exact reviewed hash, size, identifier, CDHash, team, entitlements, and Apple Silicon architecture.
