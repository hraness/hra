...
- Scan source and emitted `.next` assets for product-owned Direct markers after production builds. This scan proves only that the checked production graph excludes this development composition.
