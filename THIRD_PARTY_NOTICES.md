...
The current release path admits the immutable GitHub artifact independently. An optional npm mirror requires its own exact-byte and provenance admission; registry publication is not a prerequisite for canonical GitHub delivery.
