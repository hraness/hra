...
The static hra.sh styles and footer use the MIT-licensed `@hraness/design-kit` v0.3.0 and `@hraness/site-footer` v0.4.6 packages; `bun.lock` binds both exact release tags.
